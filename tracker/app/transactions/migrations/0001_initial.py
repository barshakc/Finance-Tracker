# Generated by Django 6.0.1 on 2026-01-19 10:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.CharField(choices=[('MONTHLY', 'Monthly'), ('YEARLY', 'Yearly'), ('WEEKLY', 'Weekly'), ('CUSTOM', 'Custom')], max_length=10)),
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('user', 'category', 'period', 'start_date', 'end_date'), name='unique_budget_per_period')],
            },
        ),
    ]
